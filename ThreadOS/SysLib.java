...
public class SysLib {
     ...
     * @returns number between 3 and 31 if successful, -1 if there was an error
     */
     ...
     * @returns number of bytes that have been read, -1 if error
     */
     ...
     * @returns the offset location of the seek pointer in the file
     */
     ...
     *
     * @param fd file whose size we want
     * @returns size in bytes of fd
     */
